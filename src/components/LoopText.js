...
const TextLoopComponent = ({
	...
	const interval = useMemo(() => parseInt(intervalProp, 10) || 3000, [intervalProp]);
	const delay = useMemo(() => parseInt(delayProp, 10) || 0, [delayProp]);
	const adjustingSpeed = useMemo(() => parseInt(adjustingSpeedProp, 10) || 150, [adjustingSpeedProp]);
