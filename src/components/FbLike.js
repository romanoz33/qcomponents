...
const FacebookLike = ({
	...
	return <Box data-qid={qid}>
		...
		{dAppID ? <FacebookProvider key={dAppID + languageConverter[language]} appId={dAppID} language={languageConverter[language]}>
			      
			<Like {...props} />
			    
		</FacebookProvider> : 'Add your Facebook App ID in the props panel.'}
	</Box>;
};
