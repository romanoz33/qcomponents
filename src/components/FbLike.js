...
const FacebookLike = ({
	...
	return <Box {...props}>
		...
		{dAppID ? <FacebookProvider key={dAppID + language} appId={dAppID} language={language}>
		...
		</FacebookProvider> : <ComponentNotice message="Add your Facebook App ID in the props panel." />}
...
const propInfo = {
	...
	kidDirectedSite: {
		...
		description: {
			ru: 'Выберите этот пункт, если ваш сайт предназначен для детей младше 13 лет'
		},
		control: 'checkbox',
		category: 'Advanced',
		weight: 1
	...
	referral: {
		title: 'UTM-метка',
		description: {
			ru: 'Метка для отслеживания переходов. Длина не должна превышать 50 символов, состоять из беквенно-цифровых символов и знаков препинания ( +/=-.:_ )'
		},
		control: 'input',
		type: 'text',
		category: 'Advanced',
