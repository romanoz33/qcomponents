...
import { Theme, Link, Text, Box, Image, Icon, Input } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"fff"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Components.ScrollIndicator height="20px">
			<Override slot="Indicator" height="20px" background="#0077cc" border-color="--color-primary" />
		...
		<Image width="64px" height="64px" src="https://test-upl.quarkly.io/60474504627982001eb71a51/images/3.png?v=2021-04-22T09:46:00.296Z" />
		<Box />
		<Section
			padding="60px 0"
			sm-padding="40px 0"
